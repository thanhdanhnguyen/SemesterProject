...
public class OneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        backgroundmusic = MediaPlayer.create(OneActivity.this, R.raw.backgroundmusic);
         ...
         */
        wrong = MediaPlayer.create(OneActivity.this, R.raw.wrong);
        correctsound = MediaPlayer.create(OneActivity.this, R.raw.correctsound);
        ...
        backGame.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(OneActivity.this, UIActivity.class));
            }
        });
